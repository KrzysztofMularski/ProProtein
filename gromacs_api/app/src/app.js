...
'`;
        ...
        const cmdsGromacs = {
            ...
            grompp1: `gmx grompp -f ions.mdp -c structure_solv.gro -p topol.top -o ions.tpr -maxwarn 10000`,
            genion: `echo 13 | gmx genion -s ions.tpr -o structure_solv_ions.gro -p topol.top -pname NA -nname CL -neutral`,
            grompp2: `gmx grompp -f minim.mdp -c structure_solv_ions.gro -p topol.top -o em.tpr -maxwarn 10000`,
            mdrun1: `gmx mdrun -v -deffnm em`,
            energy1: `echo "10 0" | gmx energy -f em.edr -o potential.xvg`,
            grompp3: `gmx grompp -f nvt.mdp -c em.gro -r em.gro -p topol.top -o nvt.tpr -maxwarn 10000`,
            mdrun2: `gmx mdrun -deffnm nvt`,
            energy2: `echo "16 0" | gmx energy -f nvt.edr -o temperature.xvg`,
            grompp4: `gmx grompp -f npt.mdp -c nvt.gro -r nvt.gro -t nvt.cpt -p topol.top -o npt.tpr -maxwarn 10000`,
            ...
            grompp5: `gmx grompp -f md.mdp -c npt.gro -t npt.cpt -p topol.top -o md_0_1.tpr -maxwarn 10000`,
